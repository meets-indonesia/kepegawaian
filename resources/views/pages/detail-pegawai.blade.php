    ...
    <div class="col-12 col-lg-6">
      <div class="card" style="width: 100%;">
        <div class="card-body">
            ...
            <button type="button" class="btn btn-outline-primary my-1" data-bs-toggle="modal" data-bs-target="#mutasiModal">Mutasi</button>
            <button type="button" class="btn btn-outline-primary my-1" data-bs-toggle="modal" data-bs-target="#gradeModal">Grade</button>
            <button type="button" class="btn btn-outline-primary my-1" data-bs-toggle="modal" data-bs-target="#golonganModal">Golongan</button>
            <button type="button" class="btn btn-outline-primary my-1" data-bs-toggle="modal" data-bs-target="#kelompokPegawaiModal">Kelompok Pegawai</button>
            <button type="button" class="btn btn-outline-primary my-1" data-bs-toggle="modal" data-bs-target="#jenisPegawaiModal">Jenis Pegawai</button>
            <button type="button" class="btn btn-outline-primary my-1" data-bs-toggle="modal" data-bs-target="#pendidikanModal">Pendidikan</button>
            <button type="button" class="btn btn-outline-primary my-1" data-bs-toggle="modal" data-bs-target="#jabatanStrukturalModal">Jabatan Struktural</button>
            <button type="button" class="btn btn-outline-primary my-1" data-bs-toggle="modal" data-bs-target="#jabatanFungsionalModal">Jabatan Fungsional</button>
        </div>
      </div>
    </div>
  </div>
